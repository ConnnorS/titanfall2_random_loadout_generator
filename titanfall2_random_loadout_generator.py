...
# pilot
tactical: list[str] = ["Cloak", "Pulse Blade", "Grapple", "Stim", "A-Wall", "Phase Shift", "Holo Pilot"]
ordnance: list[str] = ["Frag Grenade", "Arc Grenade", "Firestar", "Gravity Star", "Electric Smoke", "Satchel"]
primary: list[str] = ["R-201 Carbine", "R-101 Carbine", "Hemlok BF-R", "G2A5", "V-47 Flatline", "CAR", "Alternator", "Volt", "R-97", "Spitfire", "L-Star",
                      "X-55 Devotion", "Kraber-AP Sniper", "D-2 Double Take", "Longbow-DMR", "EVA-8 Auto", "Mastiff", "Sidewinder SMR", "EPG-1", "R-6P Softball", "EM-4 Cold War"]
secondary: list[str] = ["B3 Wingman", "Hammond P2016", "RE-45 Auto"]
anti_titan: list[str] = ["Charge Rifle", "MGL Mag Launcher", "LG-97 Thunderbolt", "Archer"]
kit1: list[str] = ["Power Cell", "Fast Regen", "Ordnance Expert", "Phase EmbarK"]
kit2: list[str] = ["Kill Report", "Wallhang", "Hover", "Low Profile", "Titan Hunter"]

# titan
titan_main_kit: list[str] = ["Assault Chip", "Stealth Auto-Eject", "Turbo Engine", "Overcore", "Nuclear Ejection", "Counter Ready"]

# titan-specific kits
titan_specific_kits: dict[str, list[str]] = {
...
# choose the titan
titan_choice: str = random.choice(list(titan_specific_kits.keys()))
